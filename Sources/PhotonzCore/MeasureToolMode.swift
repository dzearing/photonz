...
public enum MeasureToolMode: String, CaseIterable, Hashable, Codable, Sendable {
    ...
    ///
    /// Distance is three clicks and stays three clicks: the drag that landed a
    /// caliper the moment you let go was built, photographed and turned down
    /// on 2026-09-02, because placing the number yourself while you are still
    /// measuring is worth the click. See `docs/design/next-measure.md` § 3.
