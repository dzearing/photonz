...
const B_SQ = 'M4.5 4.5h8a1.6 1.6 0 0 1 1.6 1.6v8a1.6 1.6 0 0 1-1.6 1.6h-8A1.6 1.6 0 0 1 2.9 14.1v-8A1.6 1.6 0 0 1 4.5 4.5Z';
const B_CI = 'M15.1 8.9a5.2 5.2 0 1 1 0 10.4 5.2 5.2 0 0 1 0-10.4Z';
...
export const CATEGORIES = [
...

  {
    ...
    icons: [
      ...
      ['filter', P('M4.2 6.2h15.6M7.2 12h9.6M10 17.8h4'), 'Narrow a list down', 'funnel narrow refine'],
    ],
  },

  {
    ...
    icons: [
      ...
      ['library', P('M5.6 6.6h12.8M7.4 3.4h9.2') + R(3.4, 9.6, 17.2, 11, 2.4), 'Reusable assets you can place', 'assets collection kit deck'],
...

  {
    ...
    icons: [
      ...
      ['patch', P('M4.4 9.6a5.2 5.2 0 0 1 5.2-5.2h4.8a5.2 5.2 0 0 1 0 10.4H9.6a5.2 5.2 0 0 1-5.2-5.2z', "stroke-dasharray='3.2 2.8'") + P('M9.6 14.8v2.6a2.2 2.2 0 0 0 2.2 2.2h5.4a2.2 2.2 0 0 0 2.2-2.2v-2.6'), 'Patch an area from a clean source', 'replace region source-fill'],
      ['dodge-burn', C(12, 12, 8.6) + SOLID('M12 3.4a8.6 8.6 0 0 1 0 17.2z') + C(12, 12, 3.2, "stroke='black' fill='none'"), 'Lighten or darken by hand', 'dodge burn exposure-brush o'],
...

  {
    ...
    icons: [
      ...
      ['corner-radius', P('M4.4 19.6V10A5.6 5.6 0 0 1 10 4.4h9.6') + P('M4.4 4.4h3.2M4.4 4.4v3.2', "stroke-dasharray='2 2.4'"), 'Round the corners', 'radius rounding fillet'],
      ['boolean-union', `<path d='${B_SQ}${B_CI}' fill='black' stroke='none'/><path d='${B_SQ}'/><path d='${B_CI}'/>`, 'Keep both shapes as one', 'combine merge weld add'],
      ['boolean-subtract', `<path fill-rule='evenodd' d='${B_SQ}${B_CI}' fill='black' stroke='none'/><path d='${B_CI}'/>`, 'Remove the top shape', 'minus front knockout'],
      ['boolean-intersect', `<defs><clipPath id='bi'><path d='${B_SQ}'/></clipPath></defs><path d='${B_CI}' clip-path='url(#bi)' fill='black' stroke='none'/><path d='${B_SQ}'/><path d='${B_CI}'/>`, 'Keep only the overlap', 'intersection common'],
      ['boolean-exclude', `<path fill-rule='evenodd' d='${B_SQ}${B_CI}' fill='black' stroke='none'/><path d='${B_SQ}'/><path d='${B_CI}'/>`, 'Keep everything but the overlap', 'xor difference'],
      ['outline-stroke', C(12, 12, 8.6) + C(12, 12, 5.4), 'Turn a stroke into a shape', 'expand convert path'],
    ],
  },

  {
    ...
    icons: [
      ...
      ['instance', P('M12 3.4l4 4-4 4-4-4z') + P('M12 12.6l4 4-4 4-4-4z', "stroke-dasharray='2.4 2.2'"), 'An instance of a component', 'copy linked child'],
      ...
      ['opacity', C(12, 12, 8.6) + `<path d='M12 3.4a8.6 8.6 0 0 1 0 17.2z' fill='black' stroke='none' opacity='.42'/>`, 'Layer opacity', 'alpha transparency fade'],
...

  {
    ...
    icons: [
      ...
      ['scale', R(3.6, 3.6, 16.8, 16.8, 2.6) + P('M8.4 8.4h7.2v7.2') + P('M8.4 15.6l7.2-7.2'), 'Scale the selection', 'resize transform size'],
...

  {
    ...
    icons: [
      ...
      ['curves', R(3.4, 3.4, 17.2, 17.2, 2.6) + P('M4.4 19.6C8 19.6 8.8 15 12 12s4-7.6 7.6-7.6') + DOT(8.6, 15.6, 1.25) + DOT(15.4, 8.4, 1.25), 'Tone curve', 'tone rgb histogram-curve'],
      ...
      ['sharpen', P('M3.6 18.6h16.8') + P('M6 18.6l3-9 3 5.4 3-8.4 3 12'), 'Sharpen detail', 'clarity detail unsharp'],
      ['blur', C(12, 12, 4) + C(12, 12, 7.2, "stroke-dasharray='2.4 2.4' opacity='.75'") + C(12, 12, 10, "stroke-dasharray='2 2.6' opacity='.45'"), 'Blur', 'gaussian soften defocus'],
      ['noise', DOT(6.4, 6.6, 1.1) + DOT(12.4, 4.9, 1.1) + DOT(18, 7.6, 1.1) + DOT(9.2, 11.4, 1.1) + DOT(15.4, 12.4, 1.1) + DOT(5.6, 16.4, 1.1) + DOT(11.4, 18) + DOT(18.4, 16.8, 1.1), 'Grain and noise', 'grain film dither texture'],
...

  {
    ...
    icons: [
      ['bold', P('M6.6 4.4h6.6a4 4 0 0 1 0 8H6.6z') + P('M6.6 12.4h7.6a4 4 0 0 1 0 8H6.6z'), 'Bold', 'weight strong cmd-b'],
...

  {
    ...
    icons: [
      ...
      ['step-back', SOLID('M17 6.4v11.2L9.4 12z') + P('M6.6 6.4v11.2'), 'One frame back', 'frame previous nudge'],
      ['step-forward', SOLID('M7 6.4v11.2L14.6 12z') + P('M17.4 6.4v11.2'), 'One frame forward', 'frame next nudge'],
      ...
      ['trim', P('M8.2 3.6v16.8M15.8 3.6v16.8') + P('M3.6 12h3M20.4 12h-3') + R(8.2, 8.4, 7.6, 7.2, 1.4), 'Trim the in and out points', 'in out handles range'],
      ...
      ['timeline', P('M3.4 8.6h17.2M3.4 15.4h17.2') + R(4.6, 5.6, 8, 6, 1.5) + R(11.4, 12.4, 8, 6, 1.5), 'The timeline dock', 'tracks sequence edit'],
...

  {
    ...
    icons: [
      ...
      ['command', P('M8.6 3.6a2.6 2.6 0 1 1 2.6 2.6v11.6a2.6 2.6 0 1 1-2.6-2.6h6.8a2.6 2.6 0 1 1-2.6 2.6V6.2a2.6 2.6 0 1 1 2.6-2.6z'), 'The command surface', 'cmd palette command-k'],
