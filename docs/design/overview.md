...
- `canvas-hit-order.md` — what a press over overlapping canvas chrome takes hold of: the bands a press is read in, and the nearest-drawn-mark rule inside a band.
